<template>
  <div>
    <v-card>
      ...
      <v-data-table v-model="selected" select-all item-key="name" :headers="headers"
        :items="desserts" :pagination.sync="pagination" :total-items="totalDesserts"
        :loading="loading" :rows-per-page-items="rowPerPage" class="elevation-1">
