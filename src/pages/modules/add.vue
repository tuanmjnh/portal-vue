                ...
                <v-layout wrap class="pt-2">
                  ...
                  <v-flex xs12 sm4 md4>
                    <v-text-field v-model.trim="item.code" class="text-color-initial"
                      :disabled="item.id?true:false" @keyup="onExistCode()" :rules="[v=>!!v||$store.getters.languages('error.required'),$store.state.modules.exist_code||$store.getters.languages('error.exist')]"
